...
impl WorldPoint {
    ...
    pub fn from_screen_point(screensize: PhysicalSize<u32>, p: ScreenPoint) -> Self {
        Self {
            x: (p.x as f32 /screensize.width as f32 ) ,
            y: (p.y as f32 /screensize.height as f32)
        }
    }
}
...
impl WorldRectangle {
    ...
    pub fn from_screen_rect(screensize: &PhysicalSize<u32>, sr: &ScreenRectangle) -> Self {
        Self {
            pos: WorldPoint::new(sr.pos.x as f32 /screensize.width as f32 , sr.pos.y as f32 / screensize.height as f32),
